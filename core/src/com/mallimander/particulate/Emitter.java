...
//			}
			...
			int[] tY = {16, (int)(Math.random()*4+4), (int)(Math.random()*8+4),  (int)(Math.random()*8+4)};
			
			pixmap.fillTriangle(tX[0], tY[0], tX[1],  tY[2],  tX[0],  tY[1]);
			pixmap.fillTriangle(tX[0], tY[0],  tX[2],  tY[3],  tX[0],  tY[1]);
			pixmap.fillTriangle(tX[0], tY[1], tX[1],  tY[2],  (int)(Math.random()*6),  (int)(Math.random()*4));
			pixmap.fillTriangle(tX[0], tY[1],  tX[2],  tY[3],  (int)(Math.random()*6+10),  (int)(Math.random()*4));
